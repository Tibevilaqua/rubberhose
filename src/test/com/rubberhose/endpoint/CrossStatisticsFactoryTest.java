...
public class CrossStatisticsFactoryTest {
   ...
   @Test
    public void shouldReturnExactValue_when_onlyLaneAIsUsed(){
       ...
       CrossBroadStatisticDTO expectedResult = new CrossBroadStatisticDTO(2,0,0,0,0,0,new PeakPeriodDTO("00:15AM",2),54);
    ...
    public void shouldReturnExactValue_when_onlyLaneBIsUsed(){
        ...
        CrossBroadStatisticDTO expectedResult = new CrossBroadStatisticDTO(1,2,0,0,0,0,new PeakPeriodDTO("13:00PM",2),54);
